...
const CAL=[
  ...
  {date:"Sun, Mar 29",n:2,title:"Clay, Wine & Évora",iso:"2026-03-29",hotel:"bar",free:6.5,prep:"Fita Preta Wines confirmed at 12 PM. Évora guide pending.",locs:[{w:[1,1,1,1,1],l:"bar"}],acts:[
    ...
    {t:"~11:30",n:"🎨 Playing with clay",p:[0,0,1,1,1],from:"B",src:1,booked:true,par:true,d:"✅ BOOKED — Kid-focused creative workshop with the grandparents while Andy+Nicole are at the winery. Rose molds, shapes, and creates her own keepsakes to bring home.",cancel:"12h"},
  ...
  {date:"Mon, Mar 30",n:3,title:"Cookies, Shelter & Farewell",iso:"2026-03-30",hotel:"bar",free:5,note:"🔔 Grandparents' last day at Barrocal",prep:"Warm layers for nocturnal walk tonight. Sun hats, sunscreen.",locs:[{w:[1,1,1,1,1],l:"bar"}],acts:[
    {t:"~9:00",n:"Breakfast",p:[1,1,1,1,1],d:"Big leisurely breakfast. No rush — morning activities are relaxed."},
    {t:"~11:30",n:"🍪 Cookie workshop",p:[0,0,1,1,1],from:"B",src:1,booked:true,par:true,d:"✅ BOOKED — Rose bakes with Christina + Jim while Andy+Nicole are free. Rolling pins, cookie cutters, decorating.\n\nLast grandparent craft activity before they head to Cascais tomorrow.",cancel:"12h",links:[{t:"Barrocal",u:"https://barrocal.pt/experiences/"}]},
